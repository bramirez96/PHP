...
_END;
	...
	$sql = "SELECT title, username, open, close, survey_id FROM brandon.2601166_entity_surveys ES
	...
	if ($result = $connect->query($sql)) {
		...
		$thing[1] = "<ul><li class=\"push_bot_5 underline\"><a href=\"./ad_view_surveys.php?sort=title\">Survey</a></li>";
		$thing[2] = "<ul><li class=\"push_bot_5 underline\"><a href=\"./ad_view_surveys.php?sort=username\">Created By</a></li>";
		$thing[3] = "<ul><li class=\"push_bot_5 underline\"><a href=\"./ad_view_surveys.php?sort=open\">Opened On</a></li>";
		$thing[4] = "<ul><li class=\"push_bot_5 underline\"><a href=\"./ad_view_surveys.php?sort=close\">Closes On</a></li>";
		...
		while ($row = $result->fetch_row()) {
			...
			if (strtotime($row[4]) < time()) {
				$thing[5] .= "<li class=\"push_bot_5\" data-item-num-users=\"$result_id\"><a href=\"./ad_edit_user.php?id={$row[4]}\">E</a> | <a href=\"./ad_delete_survey.php?id={$row[4]}\">D</a></li>";
			} else {
				$thing[5] .= "<li class=\"push_bot_5\" data-item-num-users=\"$result_id\">E | <a href=\"./ad_delete_survey.php?id={$row[4]}\">D</a></li>";
			}
		}
		$thing[1] .= "</ul>";
		$thing[2] .= "</ul>";
